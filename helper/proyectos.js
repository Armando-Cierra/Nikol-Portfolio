const proyectos = [
    {
        slug: 'proyecto-de-uso-mixto-de-optimizacion-de-espacios',
        ...
        imagenes: [
            ...
            './img/proyectos/proyecto1/img/5.jpg',
            './img/proyectos/proyecto1/img/6.jpg',
            './img/proyectos/proyecto1/img/7.jpg',
            './img/proyectos/proyecto1/img/8.jpg',
            './img/proyectos/proyecto1/img/9.jpg',
            './img/proyectos/proyecto1/img/10.jpg',
            './img/proyectos/proyecto1/img/11.jpg',
            './img/proyectos/proyecto1/img/12.jpg',
            './img/proyectos/proyecto1/img/13.jpg',
            './img/proyectos/proyecto1/img/14.jpg',
            './img/proyectos/proyecto1/img/15.jpg',
            './img/proyectos/proyecto1/img/16.jpg',
            './img/proyectos/proyecto1/img/17.jpg'
        ]
    }, {
        slug: 'hotel-palo-verde',
        cover: './img/proyectos/proyecto2/cover.jpg',
        nombre: 'Hotel Palo Verde',
        texto: `
        ...
        imagenes: [
            ...
            './img/proyectos/proyecto2/img/5.jpg',
            './img/proyectos/proyecto2/img/6.jpg',
            './img/proyectos/proyecto2/img/7.jpg',
            './img/proyectos/proyecto2/img/8.jpg',
            './img/proyectos/proyecto2/img/9.jpg',
            './img/proyectos/proyecto2/img/10.jpg',
            './img/proyectos/proyecto2/img/11.jpg',
            './img/proyectos/proyecto2/img/12.jpg',
            './img/proyectos/proyecto2/img/13.jpg',
            './img/proyectos/proyecto2/img/14.jpg',
            './img/proyectos/proyecto2/img/15.jpg',
            './img/proyectos/proyecto2/img/16.jpg',
        ...
        texto: `
            ...
            <ol>
                <li>Seis Habitaciones.</li>
                <li>Terrazas con bar en dos niveles.</li>
        ...
        imagenes: [
            ...
            './img/proyectos/proyecto3/img/5.jpg',
            './img/proyectos/proyecto3/img/6.jpg',
            './img/proyectos/proyecto3/img/7.jpg',
            './img/proyectos/proyecto3/img/8.jpg',
            './img/proyectos/proyecto3/img/9.jpg',
            './img/proyectos/proyecto3/img/10.jpg',
            './img/proyectos/proyecto3/img/11.jpg',
            './img/proyectos/proyecto3/img/12.jpg',
            './img/proyectos/proyecto3/img/13.jpg',
            './img/proyectos/proyecto3/img/14.jpg',
            './img/proyectos/proyecto3/img/15.jpg',
            './img/proyectos/proyecto3/img/16.jpg',
            './img/proyectos/proyecto3/img/17.jpg',
            './img/proyectos/proyecto3/img/18.jpg',
            './img/proyectos/proyecto3/img/19.jpg',
            './img/proyectos/proyecto3/img/20.jpg',
            './img/proyectos/proyecto3/img/21.jpg',
        ...
        imagenes: [
            ...
            './img/proyectos/proyecto6/img/11.jpg',
            './img/proyectos/proyecto6/img/12.jpg',
            './img/proyectos/proyecto6/img/13.jpg',
            './img/proyectos/proyecto6/img/14.jpg',
            './img/proyectos/proyecto6/img/15.jpg',
            './img/proyectos/proyecto6/img/16.jpg',
            './img/proyectos/proyecto6/img/17.jpg',
        ]
    }, {
        slug: 'propuesta-para-hogar-de-ancianos-san-vicente-de-paul',
        ...
        imagenes: [
            ...
            './img/proyectos/proyecto7/img/7.jpg',
            './img/proyectos/proyecto7/img/8.jpg',
            './img/proyectos/proyecto7/img/9.jpg',
            './img/proyectos/proyecto7/img/10.jpg',
            './img/proyectos/proyecto7/img/11.jpg',
            './img/proyectos/proyecto7/img/12.jpg',
            './img/proyectos/proyecto7/img/13.jpg',
            './img/proyectos/proyecto7/img/14.jpg',
            './img/proyectos/proyecto7/img/15.jpg',
            './img/proyectos/proyecto7/img/16.jpg',
            './img/proyectos/proyecto7/img/17.jpg',
            './img/proyectos/proyecto7/img/18.jpg',
            './img/proyectos/proyecto7/img/19.jpg',
            './img/proyectos/proyecto7/img/20.jpg',
            './img/proyectos/proyecto7/img/21.jpg',
            './img/proyectos/proyecto7/img/22.jpg',
            './img/proyectos/proyecto7/img/23.jpg',
            './img/proyectos/proyecto7/img/24.jpg',
            './img/proyectos/proyecto7/img/25.jpg',
            './img/proyectos/proyecto7/img/26.jpg',
            './img/proyectos/proyecto7/img/27.jpg',
        ...
        texto: `
            ...
            <p>Los elementos que se han tomado en cuenta para poder intervenir el área de laguna y monos son:</p>
            <ol>
                <li>Árboles frutales y de grandes dimensiones.</li>
                <li>Plantas que ayuden al cuido y limpieza de la laguna.</li>
                <li>Monumentos significativos del zoológico.</li>
                <li>Piletas y caminos que ayuden a la interacción de los animales con el visitante.</li>
                <li>Juegos de entretenimiento para monos.</li>
                <li>Juegos interactivos para visitantes.</li>
